...
\normalsize{
    Launched the Developer Relations program at Grete0l as the first official hire. Defined DevRel's function within the company, established goals and  processes in alignment with the companies OKRs, and determined appropriate metrics to gauge DevRel's success. Developed technical educational content around Gretel use-cases, deployments, and synthetic data. Established the Synthetic Data Community Discord with Gretel as the primary sponsor. \\
...
\tab President of the PyTexas Foundation, a 501(c)(3) non-profit   \\
